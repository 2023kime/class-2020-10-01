...
d_2018 <- read_enrollment("raw_data/class_enrollment_summary_by_term_10.24.18.xlsx", skip_lines = 2) %>%
  mutate(year = "2018")

d_2019 <- read_enrollment("raw_data/class_enrollment_summary_by_term_12.20.19.xlsx") %>%
  mutate(year = "2018")

d_2016 <- read_enrollment("raw_data/class_enrollment_summary_by_term_fall_2016.xlsx", skip_lines = 0) %>%
  mutate(year = "2016")
d_2016
...
join_all(list(d_2015, d_2016, d_2017, d_2018, d_2019))
```
